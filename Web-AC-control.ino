...
#include <ir_Gree.h>  //  replace library based on your AC unit model, check https://github.com/crankyoldgit/IRremoteESP8266
...
struct state {
  uint8_t temperature = 23, fan = 0, operation = 0;
  bool powerStatus;
};
...
void setup() {
  ...
  //Serial.begin(115200);
  Serial.println("Iniciado Carregamento...");
